...
public final class EditVideoCommandsStr {
    ...
    public final static String[] getMakeVideoScreenshotsCommand(File videoFile, StringBuilder absoluteScreenshotFilePathStringBuilder, int framesPerSecond, int videoWidth, int videoHeight){
